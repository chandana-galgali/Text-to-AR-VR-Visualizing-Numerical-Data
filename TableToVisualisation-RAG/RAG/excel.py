...
# Example query
query = "State-wise total number of sales"
...
# Extract the visualization type and scale for the relevant description
...
# Generate the chart based on the relevant data
